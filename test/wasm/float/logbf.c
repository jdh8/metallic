...
int main(void)
{
    metallic_assert(logbf(INFINITY) == INFINITY);
    metallic_assert(logbf(-INFINITY) == INFINITY);
    metallic_assert(logbf(0) == -INFINITY);
    metallic_assert(logbf(-0.0f) == -INFINITY);
