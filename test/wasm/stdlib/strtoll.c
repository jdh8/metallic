...
int main(void)
{
    ...
    _assert(RUN("64ie1focnn5g77", "www", 25) == INT64_MAX);
    _assert(RUN("-64ie1focnn5g78", "www", 25) == INT64_MIN);

    _assert(RUN("1y2p0ij32e8e7", "...", 36) == INT64_MAX);
    _assert(RUN("-1y2p0ij32e8e8", "...", 36) == INT64_MIN);
