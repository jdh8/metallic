#include "src/math/double/log2p1.c"
#include "binary64/log2p1/log2p1_mpfr.c"
#include "../../sample.h"

static double fut(double x) { return log2p1(x); }
static double ref(double x) { return ref_log2p1(x); }
...
int main(void)
{
    ...
    ref_init();
    bad |= sample_wc_f64(fut, ref, CORE_MATH "/binary64/log2p1/log2p1.wc");
