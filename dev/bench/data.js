    ...
    "Metallic math benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "705febe46e041c2055f33696651a45f88d8abab4",
          "message": "bench: add binary128 CORE-MATH comparison",
          "timestamp": "2026-09-04T21:16:18+08:00",
          "tree_id": "25f7b8e9b602601e17b702c4f7d9a1c7fc280e22",
          "url": "https://github.com/jdh8/metallic/commit/705febe46e041c2055f33696651a45f88d8abab4"
        },
        "date": 1788527889186,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8e013548f6ea0847a6b1cc1d97e53f0402279397",
          "message": "bench: lengthen binary128 timing runs",
          "timestamp": "2026-09-04T21:19:41+08:00",
          "tree_id": "bfd720a206e14888b419f42861f479a2f1689ac8",
          "url": "https://github.com/jdh8/metallic/commit/8e013548f6ea0847a6b1cc1d97e53f0402279397"
        },
        "date": 1788528091161,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3a8156763216ac19b35f692f2137294204677abf",
          "message": "math: two-term tier for tiny expm1 arguments\n\nexpm1_tiny ran a fixed six-term Taylor chain (~26 multiplies) for every\nexponent below -19, though at e <= -62 the terms beyond t/6 sit under\n2^-124 relative.  Add expm1_tiny2: h = 1/2 -+ t/6 in 64-bit words and\none approximate t*h, ~8 multiplies, with a worst-case one-sided deficit\nof ~20 units of 2^-128 against the Ziv gate of 64.  Covers 44% of the\nexpm1 benchmark band; Rosetta proxy 0.479 -> 0.415.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>",
          "timestamp": "2026-09-04T22:27:47+08:00",
          "tree_id": "3594a64c5dba4dc017cec7adcedeabff3f07b1ed",
          "url": "https://github.com/jdh8/metallic/commit/3a8156763216ac19b35f692f2137294204677abf"
        },
        "date": 1788532175287,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ef831ea07b2b57e1020ff687913d3441ea55c333",
          "message": "math: approximate the squares in the hypot fast path\n\nThe candidate only needs the high 128 bits of ma^2 and mb^2; computing\nxh^2 + (2*xh*xl >> 64) is at most 2 units short per square and halves\nthe multiply count of the summation (8 -> 4), dropping the 256-bit\ncarry chain.  The shifted candidate moves by at most 4 units either way\n(measured over 20M pairs, full dn range), so widen the gate to 40.\nRosetta proxy: 0.412 -> 0.373.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>",
          "timestamp": "2026-09-04T22:31:56+08:00",
          "tree_id": "1b36170730514eb8c71b10609b64287b24187aee",
          "url": "https://github.com/jdh8/metallic/commit/ef831ea07b2b57e1020ff687913d3441ea55c333"
        },
        "date": 1788532559857,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6f83f82f54c1dc60b48f03fcba369fcf80422e99",
          "message": "math: streamline the binary128 root family\n\nFast paths: move rsqrt64_/sqrt_wide_ into kernel/roots.h as static\ninline (the extern sqrt_wide_ was a real call inside sqrtl and hypotl),\nderive the sqrt residual from the s0 product (2 multiplies instead of\n4, and its one-sided slack tightens from [0,3) to [0,1.5) so every\ndownstream bound keeps margin), and stage the *3 of the quadratic terms\nin 64-bit where the high half is provably zero.  sqrtl fast path: 20\nmultiplies plus a call down to 17 inlined.\n\nSlow paths: replace the stepping verifier loops with one exact integer\ncomparison against the block midpoint - a gate hit brackets the true\nroot between the midpoint's neighbors, and parity makes ties\nimpossible, so the comparison sign picks the correctly rounded\nmantissa directly.\n\nVerified bit-exact against CORE-MATH: full worst-case corpora for\nsqrtl/rsqrtl/cbrtl/hypotl/asinl/acosl and 36M random cases.  Rosetta\nproxy: sqrtl 0.49 -> 0.27, rsqrtl 0.21 -> 0.20.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>",
          "timestamp": "2026-09-04T22:43:37+08:00",
          "tree_id": "a40524505dba6ba0b86e23ac3ab3488ac8ff4a74",
          "url": "https://github.com/jdh8/metallic/commit/6f83f82f54c1dc60b48f03fcba369fcf80422e99"
        },
        "date": 1788533125670,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "4b388fafac3f6f7bc3acde6409669d4fd641bdde",
          "message": "math: narrow the cbrt quadratic correction to 64 bits\n\nThe term is ~2^17 units, so a 64-bit 5/9 and a 64-bit factor of sx\nkeep its truncation far below one unit while dropping two wide\nmultiplies to single mulq form.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>",
          "timestamp": "2026-09-04T22:48:28+08:00",
          "tree_id": "78def62a3324f28655fd3fd23973bcb8c85ceee3",
          "url": "https://github.com/jdh8/metallic/commit/4b388fafac3f6f7bc3acde6409669d4fd641bdde"
        },
        "date": 1788534042588,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6833aaffecd627f52ca59a10eb360534e22afc08",
          "message": "Revert \"math: divide-free reciprocal seed for the inverse-trig kernel\"\n\nThe premise was that the u128 division costs over a hundred cycles on the\nship target.  It does not: wasm has i64.div_u, and metallic's __udivmodti4\nresolves a 128/64 divide into two hardware divisions, so wasmtime turns the\nwhole thing into a pair of native udiv.  Measured on wasm32 the table buys\nabout 1.5% on atan2l -- the function that divides on every call -- and\nnothing distinguishable on asinl, acosl and atanl.  The 73.5 ns against\n3.4 ns that motivated it was Rosetta emulating compiler-rt's __udivti3, an\nartifact of the measurement host.\n\n512 bytes of table and seven multiplies with two adjustment loops are not\nworth 1.5% on one function, and native x86_64 has atanl 3% down since this\nseries landed.\n\nThis reverts commit 73845f2f26a3c421d27b9ecee4c724ed72cfe6ed.\n\nCo-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-09-05T01:07:37+08:00",
          "tree_id": "c2436d78847483f6aacb0b46a6af879b49495c95",
          "url": "https://github.com/jdh8/metallic/commit/6833aaffecd627f52ca59a10eb360534e22afc08"
        },
        "date": 1788541796934,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a7f55b779e150022def61452137c66b6116b1a7b",
          "message": "math: scale the float gamma error bound directly\n\nReplace ldexp with an exact power-of-two multiplication in the normal-range fast path. This preserves the Ziv bound and avoids general-purpose scaling on WebAssembly.\n\nValidation: exhaustive CORE-MATH comparison over all 2^32 float inputs and make check.wasm.fast pass. Eight paired Wasmtime runs on Apple M4, uniform inputs in [-10, 35], show a median 1.15x speedup.",
          "timestamp": "2026-09-05T06:21:36+08:00",
          "tree_id": "9998c1b4feb5c854e934747a72ad1edb5ac2732a",
          "url": "https://github.com/jdh8/metallic/commit/a7f55b779e150022def61452137c66b6116b1a7b"
        },
        "date": 1788560606084,
        "tool": "customSmallerIsBetter",
        "benches": [
